...
*   **🆕 [배움 스테이지 리디자인 제안서 (Learn Stage Redesign)](relearn/learn_stage_redesign_proposal.md)** (`learn_stage_redesign_proposal.md`): STAGE 01 배움 4채널의 지면 효율·채널 존(Zoning) 구획·정보 생략을 전방위 진단한 리디자인 제안 — Compact-first + Progressive Disclosure. **draft(승인 대기).**
