...
- **[Daily Digest Calendar UI](design/PriSincera_Daily_Calendar_UI.md)**: 인터랙티브 캘린더 그리드(Chrono-Calendar) 및 0-Lag 퀵피크 UX 리뉴얼 사양서
- **[PaceNote Weekly Calendar UI](design/PriSincera_PaceNote_Calendar_UI.md)**: 분기별 13주 벤트 박스 매트릭스 및 가로 스크롤 타임라인 주차 내비게이션 리뉴얼 제안서
