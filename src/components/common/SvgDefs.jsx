    ...
    <svg style={{ position: 'absolute', width: 0, height: 0 }} aria-hidden="true">
      <defs>
        ...
        <linearGradient id="g-down" x1="50%" y1="100%" x2="50%" y2="0%">
          <stop offset="0%" stopColor="var(--color-indigo)" stopOpacity="0.75"/>
          <stop offset="100%" stopColor="var(--bg-deep)" stopOpacity="0.2"/>
        </linearGradient>
        <linearGradient id="g-edge" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--prism-lavender)" stopOpacity="0.6"/>
          <stop offset="100%" stopColor="var(--color-indigo)" stopOpacity="0.3"/>
        </linearGradient>
        ...
        <linearGradient id="g-amber" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="var(--color-gold-light)" stopOpacity="0.7"/>
        </linearGradient>
        <radialGradient id="g-core-glow" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="var(--prism-lavender)" stopOpacity="0.4"/>
          <stop offset="60%" stopColor="var(--color-indigo)" stopOpacity="0.15"/>
