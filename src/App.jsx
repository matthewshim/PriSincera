...
const PlannersViewDetail = lazy(() => import('./pages/PlannersViewDetail'));
      ...
      <Suspense fallback={PageFallback}>
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            {/* Planner's View — 루트=목록, 슬러그=퍼머링크 (publishing_guide v2.0).
                'archive'·'all'·'index'는 향후 하위 라우트를 위한 예약 슬러그로 쓰지 않는다. */}
            <Route path="planners-view" element={<PlannersView />} />
            <Route path="planners-view/:slug" element={<PlannersViewDetail />} />
