        ...
        <section className="daily-hero">
          <div className="daily-hero-content">
            ...
            <div className="daily-subscribe-wrap">
              <button 
                className={`daily-google-sub-btn ${subStatus}`} 
                onClick={handleGoogleSubscribe} 
                disabled={subStatus === 'loading' || subStatus === 'success' || subStatus === 'already_subscribed'}
                style={subStatus === 'success' || subStatus === 'already_subscribed' ? { borderColor: 'rgba(52, 211, 153, 0.5)', background: 'rgba(52, 211, 153, 0.1)', color: '#34D399' } : {}}
              >
                ...
                {subStatus === 'loading' ? '구독 처리 중...' : 
                 ...
                 subStatus === 'already_subscribed' ? '✨ 이미 구독 중이에요 : 내일 아침 만나요!' : 'Google 계정으로 데일리 무료 구독하기'}
              </button>
